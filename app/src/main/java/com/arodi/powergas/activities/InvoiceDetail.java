...
import com.arodi.powergas.databinding.InvoiceDetailBinding;
...
public class InvoiceDetail extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding =DataBindingUtil.setContentView(this, R.layout.invoice_detail);
        user = new SessionManager(this).getLoginDetails();
        invoiceEntity = getIntent().getParcelableExtra("InvoiceInformation");
    ...
    public void populateSales() {
        try {
            JSONArray jSONArray = new JSONArray(invoiceEntity.getProducts());
    ...
    public void makeSale() {
        final SweetAlertDialog dialog = new SweetAlertDialog(InvoiceDetail.this, SweetAlertDialog.PROGRESS_TYPE);
        ...
        try {
            ...
            jsonObject.put("items", new JSONArray(invoiceEntity.getProducts()));
            jsonArray.put(jsonObject);
            System.out.println("hfhfhfhfhfhfhuyyyf" + jsonArray.toString());

            JSONObject object = new JSONObject();
            object.put("items", new JSONArray(invoiceEntity.getPayments()));
            array.put(object);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        RequestBody requestBody = new MultipartBody.Builder()
                ...
                .addFormDataPart("shop_id", this.invoiceEntity.getShop_id())
                .addFormDataPart("total", this.invoiceEntity.getGrand_total())
        ...
        client.newCall(request).enqueue(new Callback() {
            public void onFailure(Call call, IOException iOException) {
                runOnUiThread(() -> {
                    dialog.dismiss();
                    Toast.makeText(InvoiceDetail.this, "No Connection to host", Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        if (jSONObject.getString(FirebaseAnalytics.Param.SUCCESS).equals("1")) {
                            ...
                            dialog.setConfirmClickListener(sweetAlertDialog -> {
                                ...
                                Intent intent = new Intent(InvoiceDetail.this, MainActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                                startActivity(intent);
                            });
                        }else {
                            dialog.dismiss();
                            Toast.makeText(InvoiceDetail.this, jSONObject.getString("message"), Toast.LENGTH_LONG).show();
                        }

                    } catch (Exception e) {
                        dialog.dismiss();
                        Toast.makeText(InvoiceDetail.this, "An error occurred", Toast.LENGTH_LONG).show();
                        e.printStackTrace();
                    }
                });
