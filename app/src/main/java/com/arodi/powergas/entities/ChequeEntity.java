...
@Entity
public class ChequeEntity implements Parcelable {
    ...
    public ChequeEntity(String sale_id, String date, String customer, String customer_id, String payment_status, String grand_total, String products, String shop_name, String lat, String lng, String image, String phone, String customer_group_name, String city, String shop_id, String payments, String updated_at) {
    ...
    protected ChequeEntity(Parcel in) {
    ...
    public static final Creator<ChequeEntity> CREATOR = new Creator<ChequeEntity>() {
        @Override
        public ChequeEntity createFromParcel(Parcel in) {
            return new ChequeEntity(in);
        }

        @Override
        public ChequeEntity[] newArray(int size) {
            return new ChequeEntity[size];
        }
    };
